<template>
    ...
    <div class="main-container" >
        ...
        <div class="img-container">
            <img src="/images/header/header3.jpg" alt="Norway" style="width:100%;">
            <div class="text-block">
                <p>CDA Interview Guide</p>
             </div>
        </div>

        <!-- Main bodu content -->
        <div class ="body-container">
            <p class="home-heading">Ultimate Guide to CDA Structured Interview: Tips & Proven Strategies to Help You Prepare & Ace Your CDA Interview</p>

            <p class="home-heading">Overview:</p>

            <div>
                <span>The purpose of the dental school interview</span><br>
                ...
                <span><a href="">How to prepare for your CDA Interview</a></span><br>
                <span><a href="">Sample CDA interview questions</a></span><br>
                <span><a href="">BeMo CDA-structured interview prep program</a></span><br>
                <span><a href="">Contact us</a></span><br>
            </div>
            <br>
            <p class="home-heading">What is the purpose of the dental school interview?</p>
            ...
            <p class="home-heading">History, rationale, and the structure of the CDA interview</p>
            ...
            <p class="home-heading">Types of Questions</p>
            ...
            <p class="home-heading">The Seven Competencies</p>
            ...
            <p class="home-heading"> Structure of the CDA interview</p>
            ...
            <p>Click <a href=""> here </a> to learn how to prepare for your CDA interview</p>

            <p>Click <a href=""> here </a> to practice with our sample CDA interview questions</p>

            <p>Click <a href=""> here </a> to learn more about our money-back guarantee CDA interview preparation programs.</p>

            <p class="home-heading">Reference:</p>
